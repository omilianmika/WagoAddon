...
local pvpStrategies = {
    ...
    ROGUE = {
        offensive = {
            {spell = "Blizzard", priority = 1, condition = function() return not UnitIsVisible("target") end},
            {spell = "Frost Nova", priority = 2, condition = function() return IsSpellInRange("Kidney Shot", "target") end},
            {spell = "Polymorph", priority = 3},
            {spell = "Ice Lance", priority = 4}
        },
        defensive = {
            {spell = "Ice Block", priority = 1, condition = function() return UnitDebuff("player", "Blind") end},
            {spell = "Counterspell", priority = 2, condition = function() return UnitCastingInfo("target") end},
            {spell = "Ice Barrier", priority = 3, condition = function() return not UnitBuff("player", "Ice Barrier") end}
        }
    },
    HUNTER = {
        offensive = {
            {spell = "Polymorph", priority = 1, condition = function() return UnitExists("pettarget") end},
            {spell = "Counterspell", priority = 2, condition = function() return UnitCastingInfo("target") end},
            {spell = "Frost Nova", priority = 3, condition = function() return IsSpellInRange("Scatter Shot", "target") end},
            {spell = "Blink", priority = 4, condition = function() return IsSpellInRange("Scatter Shot", "target") end},
            {spell = "Ice Lance", priority = 5}
        },
        defensive = {
            {spell = "Ice Barrier", priority = 1, condition = function() return not UnitBuff("player", "Ice Barrier") end},
            {spell = "Blink", priority = 2, condition = function() return IsSpellInRange("Scatter Shot", "target") end},
            {spell = "Counterspell", priority = 3, condition = function() return UnitCastingInfo("target") end}
        }
    },
    PRIEST = {
        offensive = {
            {spell = "Frostbolt", priority = 1},
            {spell = "Counterspell", priority = 2, condition = function() return UnitCastingInfo("target") end},
            {spell = "Polymorph", priority = 3},
            {spell = "Ice Lance", priority = 4}
        },
        defensive = {
            {spell = "Ice Block", priority = 1, condition = function() return UnitDebuff("player", "Psychic Scream") end},
            {spell = "Blink", priority = 2, condition = function() return UnitDebuff("player", "Mind Flay") end},
            {spell = "Ice Barrier", priority = 3, condition = function() return not UnitBuff("player", "Ice Barrier") end}
        }
    },
    MAGE = {
        offensive = {
            {spell = "Counterspell", priority = 1, condition = function() return UnitCastingInfo("target") end},
            {spell = "Polymorph", priority = 2},
            {spell = "Frostbolt", priority = 3},
            {spell = "Ice Lance", priority = 4}
        },
        defensive = {
            {spell = "Blink", priority = 1, condition = function() return UnitDebuff("player", "Frost Nova") end},
            {spell = "Ice Barrier", priority = 2, condition = function() return not UnitBuff("player", "Ice Barrier") end},
            {spell = "Ice Block", priority = 3, condition = function() return UnitDebuff("player", "Polymorph") end}
        }
    },
    WARLOCK = {
        offensive = {
            {spell = "Polymorph", priority = 1, condition = function() return UnitExists("pettarget") end},
            {spell = "Counterspell", priority = 2, condition = function() return UnitCastingInfo("target") end},
            {spell = "Frost Nova", priority = 3},
            {spell = "Ice Lance", priority = 4}
        },
        defensive = {
            {spell = "Ice Block", priority = 1, condition = function() return UnitDebuff("player", "Fear") end},
            {spell = "Ice Barrier", priority = 2, condition = function() return not UnitBuff("player", "Ice Barrier") end},
            {spell = "Blink", priority = 3}
        }
    },
    PALADIN = {
        offensive = {
            {spell = "Polymorph", priority = 1},
            {spell = "Counterspell", priority = 2, condition = function() return UnitCastingInfo("target") end},
            {spell = "Frost Nova", priority = 3},
            {spell = "Ice Lance", priority = 4}
        },
        defensive = {
            {spell = "Ice Block", priority = 1, condition = function() return UnitDebuff("player", "Hammer of Justice") end},
            {spell = "Blink", priority = 2, condition = function() return IsSpellInRange("Hammer of Justice", "target") end},
            {spell = "Ice Barrier", priority = 3, condition = function() return not UnitBuff("player", "Ice Barrier") end}
        }
    },
    DRUID = {
        offensive = {
            {spell = "Counterspell", priority = 1, condition = function() return UnitCastingInfo("target") end},
            {spell = "Polymorph", priority = 2, condition = function() return UnitCreatureType("target") == "Humanoid" end},
            {spell = "Frost Nova", priority = 3, condition = function() return UnitCreatureType("target") == "Beast" end},
            {spell = "Ice Lance", priority = 4}
        },
        defensive = {
            {spell = "Blink", priority = 1, condition = function() return UnitCreatureType("target") == "Beast" end},
            {spell = "Ice Block", priority = 2, condition = function() return UnitDebuff("player", "Hibernate") end},
            {spell = "Ice Barrier", priority = 3, condition = function() return not UnitBuff("player", "Ice Barrier") end}
        }
    },
    SHAMAN = {
        ...
        defensive = {
            {spell = "Blink", priority = 1, condition = function() return UnitDebuff("player", "Frost Shock") end},
            {spell = "Counterspell", priority = 2, condition = function() return UnitCastingInfo("target") end},
            {spell = "Ice Barrier", priority = 3, condition = function() return not UnitBuff("player", "Ice Barrier") end}
        }
    }
